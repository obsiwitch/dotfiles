...
# Display
xfconf-set 'blank-on-battery' 'int' '0'
xfconf-set 'dpms-on-battery-sleep' 'uint' '0'
xfconf-set 'dpms-on-battery-off' 'uint' '5'

xfconf-set 'blank-on-ac' 'int' '0'
xfconf-set 'dpms-on-ac-sleep' 'uint' '0'
xfconf-set 'dpms-on-ac-off' 'uint' '5'
